    ...
    pintarTarjetasDepartamentos(listaDepartamentos) {
        ...
        listaDepartamentos.forEach((dep) => {
            ...
            if (nombreDepLower.includes('finanz') || nombreDepLower.includes('contab') || nombreDepLower.includes('presupuesto')) {
                // Icono de finanzas / gráficas
                iconoSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chart-no-axes-combined"><path d="M12 16v5"/><path d="M16 14.639V21"/><path d="M20 10.656V21"/><path d="m22 3-8.646 8.646a.5.5 0 0 1-.708 0L9.354 8.354a.5.5 0 0 0-.707 0L2 15"/><path d="M4 18.463V21"/><path d="M8 14.656V21"/></svg>`;
                ...
                iconoSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-code-xml"><path d="m18 16 4-4-4-4"/><path d="m6 8-4 4 4 4"/><path d="m14.5 4-5 16"/></svg>`;
                ...
                // Icono de materiales / recibo / caja
            ...
            } else if (nombreDepLower.includes('regional')) {
                // Icono específico para Dirección Regional (edificio principal / corona / globe)
            ...
            } else if (nombreDepLower.includes('administrac')) {
                // Icono específico para Dirección de Administración (portafolio / maletín)
                iconoSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-briefcase"><rect width="20" height="14" x="2" y="7" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>`;
            } else {
