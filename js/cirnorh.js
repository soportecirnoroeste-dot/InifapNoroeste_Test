...
// Función de Bienvenida Específica para Recursos Humanos con el SVG de Handshake asegurado
function cargarBienvenidaRh() {
    ...
    // Cambia esto en tu script maestro para que ya no dependa de options[0]:
    ...
    document.getElementById('header-icon').innerHTML = iconoHandshakeFijo;
...
// Función auxiliar para renderizar los módulos estándar
