                    ...
                    <div class="flex flex-col xl:flex-row items-stretch xl:items-center justify-between gap-6">
                        ...
                        <div class="flex flex-wrap items-end gap-3">
                            ...
                            <div class="flex items-center gap-2 pt-4 xl:pt-0">
                                <label id="labelCargaDatos" for="uploadBiometrico" class="px-4 py-2 bg-[#249444] text-white rounded-xl text-xs font-bold hover:bg-[#1e7a37] transition flex items-center gap-2">
